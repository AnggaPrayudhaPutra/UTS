          ...
          <ul class="list-task todo-list list-group mb-0" data-role="tasklist">
            <li class="list-group-item todo-item" data-role="task">
              ...
              <ul class="list-style-none assignedto">
                <li class="assignee">
                  <img class="rounded-circle" width="40" src="<?= base_url();?>/assets/images/users/1.jpg" alt="user"
                    data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave" />
                </li>
                <li class="assignee">
                  <img class="rounded-circle" width="40" src="<?= base_url();?>/assets/images/users/2.jpg" alt="user"
                    data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica" />
                </li>
                <li class="assignee">
                  <img class="rounded-circle" width="40" src="<?= base_url();?>/assets/images/users/3.jpg" alt="user"
                    data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka" />
                </li>
                <li class="assignee">
                  <img class="rounded-circle" width="40" src="<?= base_url();?>/assets/images/users/4.jpg" alt="user"
      ...
      <div class="card-body">
        ...
        <div class="chat-box scrollable" style="height: 475px">
          ...
          <ul class="chat-list">
            ...
            <li class="chat-item">
              <div class="chat-img">
                <img src="<?= base_url();?>/assets/images/users/2.jpg" alt="user" />
              </div>
              <div class="chat-content">
            ...
            <li class="chat-item">
              <div class="chat-img">
                <img src="<?= base_url();?>/assets/images/users/3.jpg" alt="user" />
              </div>
              <div class="chat-content">
